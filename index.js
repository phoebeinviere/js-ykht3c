...
$(document).ready(function () {
  $('tbody tr td').each(
    ...
    function() {
        ...
        if (value == fTcolor00) {
          $(this).addClass('fTcolor00');
        }
        else if (value > fTcolor20) {
          if (value > fTcolor30) {
            if (value > fTcolor35) {
              if (value > fTcolor35 && value <= fTcolor36) {
              ...
              if (value > fTcolor30 && value <= fTcolor31) {
            ...
            if (value > fTcolor25) {
              if (value > fTcolor25 && value <= fTcolor26) {
              ...
              if (value > fTcolor20 && value <= fTcolor21) {
          ...
          if (value > fTcolor10) {
            if (value > fTcolor15) {
              if (value > fTcolor15 && value <= fTcolor16) {
              ...
              if (value > fTcolor10 && value <= fTcolor11) {
            ...
            if (value > fTcolor05) {
              if (value > fTcolor05 && value <= fTcolor06) {
